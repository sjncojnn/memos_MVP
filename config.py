...
# GHI CHÚ DEMO: các giá trị dưới đây (STABLE_CACHE_MIN_HITS, HOT_ACCESS_THRESHOLD) có thể bị
# GHI ĐÈ lúc runtime từ sidebar app_streamlit.py (mutate trực tiếp thuộc tính module `config`)
# để demo hiệu ứng cache/tiering nhanh trong vài lượt hỏi thay vì phải đợi nhiều ngày.
# Giá trị mặc định dưới đây dùng cho môi trường "thật" (không demo).
